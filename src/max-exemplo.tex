...
\begin{document}
  ...
  \epigrafe{A imaginação é mais importante que o conhecimento.}{Albert Einstein}
...
\label{sec:citacoes}
 ...
 Citações curtas podem ser feitas \enquote{o comando quote} ou direto com ``duas crases e dois apóstrofos.'' Citações longas devem usar o comando \verb*|longquote|
  ...
  Para uma citação curta no meio do parágrafo, \verb|\citacao| põe as aspas do idioma do trabalho: \citacao{a imaginação é mais importante que o conhecimento}.\index{citação!curta}
