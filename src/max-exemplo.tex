...
\begin{document}
  ...
  % A banca da folha de aprovacao e o que voce declara com \examiner, na
  % ordem: o orientador, que preside a banca, e o primeiro (3.1.2.1.3e). A
  % classe nao o poe la sozinha; a opcao `orientadorexamina' faz isso.
  \examiner{Nome do Primeiro Orientador Sobrenome}{D.Sc.}{UFRJ}
