...
%%
%% coppe.dtx  (with options: `minexemplo')
%% 
...
%% 
\documentclass[dsc,pdfa,orientadorexamina]{coppe}
%% min-exemplo.tex -- tudo o que a norma exige, e nada além disso.
%%
%% O que está aqui e por quê (Manual UFRJ/SiBI, 9.ª ed. rev., 2026):
%%  - pdfa ................ o depósito é em PDF/A (2.2d);
%%  - orientadorexamina ... a 3.1.2.1.3(e) põe o orientador em primeiro lugar
%%    na banca da folha de aprovação, como presidente;
%%  - \maketitle .......... capa, folha de rosto (3.1.2.1.1) e folha adicional
%%    com a Coleta CAPES e a ficha catalográfica (3.1.2.1.2);
%%  - \frontmatter ........ folha de aprovação (3.1.2.1.3);
...
%% todas as listas além do sumário, subtítulo, coorientador, linha de pesquisa,
...
\begin{document}
  ...
  % Folha de rosto e folha adicional: área de concentração (3.1.2.1.1e) e os
  % campos da Coleta CAPES (3.1.2.1.2). A ficha catalográfica vem do gerador do
  % SiBI; com o arquivo em mãos, descomente a linha \fichacatalografica.
