...
\begin{document}
  ...
  %  - \printlosymbols ......... opcional (3.1.2.2.7).
...
use \verb|\href{https://exemplo.org}{texto}|. Evite digitar URLs como texto comum --- elas não quebram e estouram a margem.
  ...
  \begin{itemize}
    \item \textbf{Pode desligar} se o trabalho \emph{não} tem índice remissivo, nem vários índices (\verb|imakeidx|, \verb|splitidx|), nem glossário, nem nomenclatura, e não soma listas além das deste exemplo.
