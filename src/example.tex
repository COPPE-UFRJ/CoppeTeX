...
Há estilos prontos também para \verb|java|, \verb|xml|, \verb|html| e \verb|prolog|.
Há também \verb|\pythoninline| e \verb|\javainline| para código no meio do
texto, e o ambiente \verb|Verbatim| (com as opções acima) para a saída de programas. Para algoritmos, use o ambiente \verb|algorithm| com as palavras-chave em português \verb|\Para| e \verb|\Enquanto|, como no \autoref{alg:soma}.
