%%
%% This is file `coppe-min-exemplo.tex',
...
%% coppe-min-exemplo.tex -- tudo o que a norma exige, e nada além disso.
%%
...
%% glossário, apêndices, anexos e índice. Tudo isso está no coppe-max-exemplo.tex.
...
\begin{document}
  ...
  % A composição da banca é regra do Programa, não da formatação. A folha de
  % aprovação lista o que você declara aqui, na ordem: o orientador, que
  % preside a banca, é o primeiro (3.1.2.1.3e).
  ...
  % (sumário), sempre o último. O coppe-max-exemplo.tex mostra onde entram os
...
%% 
%%
%% End of file `coppe-min-exemplo.tex'.
