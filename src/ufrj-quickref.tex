...
\begin{center}
  ...
  it in English. A thesis starts with the class and the style of its academic
  unit, \verb|\documentclass[dsc]{ufrj}| and, at COPPE,
  \verb|\usepackage{ufrj-coppe}|; everything below is the class.
...
\textbackslash department & \textbackslash department\{PESC\} & \doc & The Programa's acronym, as the unit style declares it (\texttt{ufrj-coppe} declares COPPE's thirteen). \\
...
Worked examples: \texttt{min-exemplo.tex} (only what is mandatory) and \texttt{max-exemplo.tex} (everything).\quad
