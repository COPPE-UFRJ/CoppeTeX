...
A classe LaTeX \texttt{coppe}, versões 4.0 e posteriores (\textbf{CoppeTeX
4.x}), distribuída em \url{https://github.com/COPPE-UFRJ/CoppeTeX}, é a
implementação de referência desta Norma. Produz, sem configuração adicional por
