%%
%% test_listas.tex -- regression test for the ufrj class.
%%
...
%% ufrj.ist, entre a primeira e a segunda passada. O build-check.ps1 faz isso.
%%
...
% \mathbb vem de uma fonte matematica, que a classe nao carrega (#90).
\ifPDFTeX\usepackage{amssymb}\else\usepackage{unicode-math}\fi
