...
BUG: a prova da versao nao rodava tools/conferir-referencias.py nem tools/conferir-norma.py; a referencia m-diss do exemplo.bib saiu errada na 4.1 (rt66) com o verificador acusando a divergencia -- mas ninguem o chamava (#151).
