...
\usepackage{subcaption}      % subfiguras/subtabelas (NÃO use subfig/subfigure)
...
Para inserir código no meio do texto use \verb|\pythoninline|, como em \pythoninline{saudacao(nome)}; e para mostrar a saída de um programa use o ambiente \verb|gxoutput| (verbatim):
