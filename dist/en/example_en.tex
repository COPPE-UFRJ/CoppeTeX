...
%%
%% ufrj.dtx  (with options: `exampleen')
%% 
...
\begin{document}
  ...
  \begin{foreignabstract}
    Este é o resumo em língua estrangeira, que aqui é o português. Quem o
    produz é o ambiente \texttt{foreignabstract}, quando o idioma principal
    do trabalho é o inglês.
  \end{foreignabstract}
  ...
  and embeds the colour profile. Turn it on early, as \texttt{max-exemplo.tex}
